...
class Dual_Annealing():
    ...
    def __init__(self, numCyc, numTrial, pInit, pEnd, tInit, tEnd, mainRoom, bathRoom, intention_set, maxNumTraj, 
                 bedPlacement, mainDoorPlacement):
        ...
        self.env.append(Environment_Generated(mainRoom, bathRoom, furnMainStat, furnBathStat, lightMainStat, 
                                              lightBathStat, doorMainStat, doorBathStat,
                                              self.numOfRows, self.numOfCols, bedPlacement = bedPlacement,
                                              mainDoorPlacement = mainDoorPlacement))
...
#            for trial in range(1,numTrial):
            ...
            while trial < numTrial :
              ...
              self.env.append(Environment_Generated(mainRoom, bathRoom, furnMainStat, furnBathStat, lightMainStat, lightBathStat,
                                                    doorMainStat, doorBathStat, self.numOfRows, self.numOfCols,
                                                    bedPlacement = bedPlacement, mainDoorPlacement = mainDoorPlacement))
              '''PLOTTING THE ROOM'''
              plt.show()
              for room in self.env[-1].roomList:

...
bedPlacement = 'h' # 'h' for headwall toilet placement, 'f' for footwall toilet placement
...
for i in range(1): # number of runs
  numCyc = 2; numTrial = 3;# numCyc = 25, numTrial = 30
...
#  intention_set = {'start': ['Sofa', 'Sofa'], 'end': ['Cabinet', 'Chair-Patient'], 'frequency': [2, 2, 1, 1, 1, 1, 1, 1, 1, 1, 1]} # for test
  ...
  annealingOptimization = Dual_Annealing(numCyc, numTrial, pInit, pEnd, tInit, tEnd, mainRoom, bathRoom, intention_set, maxNumTraj, bedPlacement)
